      ...
      >
        <div className="w-full flex items-center justify-between px-6 py-3 md:px-10">
          <div className="flex items-center gap-4">
            <a
              href="/"
              className="flex items-center gap-2 text-gray-800 dark:text-gray-200 font-medium hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500"
            >
          ...
          <div className="px-6 pb-6 pt-4 space-y-3">
            {[
              ...
              <a
                ...
                className="block text-base font-medium text-gray-800 dark:text-gray-100 py-2 hover:underline"
              >
                {item}
              </a>
            ))}
